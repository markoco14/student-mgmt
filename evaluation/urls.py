...
urlpatterns = [
    ...
    path('evaluation-attributes/',
		 evaluation_attribute_views.EvaluationAttributeList.as_view(),
         name="evaluation-attribute-list"),
    path('evaluation-attributes/<str:evaluation_attribute_pk>/',
         evaluation_attribute_views.EvaluationAttributeDetail.as_view(),
		 name="evaluation-attribute-detail"),

    # RANGE ATTRIBUTE
    path('range-attributes/',
		 range_attribute_views.RangeEvaluationAttributeList.as_view(),
         name="range-attribute-list"),
    path('range-attributes/<str:range_attribute_pk>/',
         range_attribute_views.RangeEvaluationAttributeDetail.as_view(),
		 name="range-attribute-detail"),

    # TEXT ATTRIBUTE
    path('text-attributes/',
		 text_attribute_views.TextEvaluationAttributeList.as_view(),
         name="text-attribute-list"),
    path('text-attributes/<str:text_attribute_pk>/',
         text_attribute_views.TextEvaluationAttributeDetail.as_view(),
