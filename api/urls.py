...
urlpatterns = [
    ...
    # SCHOOL DAY ROUTES
    path('schools/<str:school_pk>/days/', school_views.SchoolDayList.as_view(), name='school-day-list'),
    path('schools/days/<str:school_day_pk>/', school_views.SchoolDayDetail.as_view(), name='school-day-detail'),
